                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("summary") && el.closest("[data-spollers]")) {
                        ...
                        if (el.closest("[data-spollers]").classList.contains("_spoller-init")) {
                            ...
                            const spollerSpeed = spollersBlock.dataset.spollersSpeed ? parseInt(spollersBlock.dataset.spollersSpeed) : 1e3;
            ...
            if (document.querySelector(".section-specialize")) {
                ...
                document.addEventListener("click", (e => {
                    if (isOpenButton(e.target)) {
                        ...
                        showGallery(wrapper);
                    } else if (e.target.closest(".section-specialize__hide-button") && e.target.closest("._mob-active")) {
                        e.preventDefault();
                        e.target.closest("._mob-active").classList.remove("_mob-active");
